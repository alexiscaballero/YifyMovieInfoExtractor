...
public class Torrent {
     ...
     * @param size
     */
    public Torrent(String url, String hash, String quality, Long seeds, Long peers, String size, Long sizeBytes, String dateUploaded, Long dateUploadedUnix) {
        this.url = url;
        this.hash = hash;
    ...
    public Torrent withSeeds(Long seeds) {
        this.seeds = seeds;
        return this;
    }
    ...
    public Torrent withPeers(Long peers) {
        this.peers = peers;
        return this;
    }
    ...
    public Torrent withDateUploadedUnix(Long dateUploadedUnix) {
        this.dateUploadedUnix = dateUploadedUnix;
        return this;
    }
