...
public class Movie {
     ...
     */
    public Movie(Integer id, String url, String imdbCode, String title, String titleEnglish, String titleLong, String slug, Integer year, Double rating, Integer runtime, List<String> genres, Integer downloadCount, Integer likeCount, String descriptionIntro, String descriptionFull, String ytTrailerCode, String language, String mpaRating, String backgroundImage, String backgroundImageOriginal, String smallCoverImage, String mediumCoverImage, String largeCoverImage, List<Torrent> torrents, String dateUploaded, Integer dateUploadedUnix) {
        this.id = id;
        this.url = url;
    ...
    public Movie withDownloadCount(Integer downloadCount) {
        this.downloadCount = downloadCount;
        return this;
    }
    ...
    public Movie withLikeCount(Integer likeCount) {
        this.likeCount = likeCount;
        return this;
    }
    ...
    public Movie withDescriptionIntro(String descriptionIntro) {
        this.descriptionIntro = descriptionIntro;
        return this;
    }
    ...
    public Movie withDateUploadedUnix(Integer dateUploadedUnix) {
        this.dateUploadedUnix = dateUploadedUnix;
        return this;
    }
